...
MODEL_INFO = {
        ...
        "keys": ["RSI_15","RSI_10"],  #ADJUST YOUR KEYS TO the tOP two
        "inputs": [{"name": k, "type": "number", "min": -100.0, "max": 100.0, "default": 0.0, "step": 10.0} for k in ["RSI_15","RSI_10"]] #ALSO HEREEE
}
